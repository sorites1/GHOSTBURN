...
**Cause:** When a condition or injury makes it nearly impossible to [[ch3_Move|move]], you are \[Movement Restricted\]. This condition replaces \[[[ch2_Condition_Movement_Impaired|Movement Impaired]]\].

**Effect:** When you spend 1 AP to move in combat, you can move only 1 meter, usually by crawling. You cannot use Athletics skill actions.
