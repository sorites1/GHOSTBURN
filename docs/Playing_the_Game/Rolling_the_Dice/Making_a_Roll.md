...
4. **Difficulty Level** - The trick specifies the [Difficulty Level](../../Playing_the_Game/Rolling_the_Dice/Difficulty_Level.md) for the roll. The GM adjusts the Difficulty Level up or down, as described in [Adjusting the Difficulty Level](../../Playing_the_Game/Rolling_the_Dice/Adjusting_the_Difficulty_Level.md). 
...
6. **Ability Score and Skill Bonus** - Add the primary ability score based for the skill you're using. If you have a [skill bonus](../../Lexicon/Keywords/Keyword_Skill_Bonus.md), add that too. For example, the Firearms skill is associated with Agility. If your character has an Agility score of 3 and a +1 skill bonus in Firearms, you would add +4 to your Firearms roll.

7. **Gear and Aug Bonuses** - If you have a [gear bonus](../../Lexicon/Keywords/Keyword_Gear_Bonus.md) from a piece of equipment or an [aug bonus](../../Lexicon/Keywords/Keyword_Aug_Bonus.md) from a cybernetic augmentation or psionic mutation, add those as well. For example, using a laser sight grants a +1 gear bonus to Firearms rolls. Bonuses of the same type do not stack, as described below.
   
8. **Result of the Roll** - The sum of your dice roll, plus your ability score and your bonuses is called the result. 
   
9. **Luck Bonus** - After you roll the dice and determine the result, you can spend a [Luck Point](../../Playing_the_Game/Rolling_the_Dice/Luck_Points.md) to add a [Luck Bonus](../../Lexicon/Keywords/Keyword_Luck_Bonus.md) to the result. 
