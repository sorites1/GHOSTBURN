...
When these rules do not cover the action a player wants their character to perform, the GM can declare it an [improvised trick](../Keywords/Keyword_Improvised_Trick.md). The GM sets the DL using their best judgement. Refer to the DL chart above and use one of the standard five Difficulty Levels: Easy (8), Moderate (14), Hard (20), Severe (26), and Extreme (32).