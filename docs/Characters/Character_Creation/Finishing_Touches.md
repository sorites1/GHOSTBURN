...
[⇐ Back](../../Characters/Character_Creation/Starting_Package.md) | End of Character Creation
...
You start the game with one [Luck Point](../../Playing_the_Game/Rolling_the_Dice/Luck_Points.md). Write a 1 in the space labeled Luck Points on your character sheet. Later in the game, once you've earned XP, you can purchase up to two more Luck Points, for a maximum of three.

## Derived Characteristics

Your **Health Levels**, **Mesh**, and **Stabilization DL** are derived from your other ability scores.
...
| ------------------------ | --------------------------- |
| Healthy (Max Hit Points) | (Strength + Resilience) x 5 |
