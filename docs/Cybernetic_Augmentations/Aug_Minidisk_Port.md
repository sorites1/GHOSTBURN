...
| :-------: | ----------------------- | :-------: | :--------------------------------------------------------------------------------------- |
|  5,000 ⌆  | Minidisk Port (Level 1) |     1     | [[One Hand](../Keywords/Keyword_One_Hand\.md)], [[Physical](../Keywords/Keyword_Physical\.md)] |
| 10,000 ⌆  | Minidisk Port (Level 2) |     1     | [[One Hand](../Keywords/Keyword_One_Hand\.md)], [[Physical](../Keywords/Keyword_Physical\.md)] |
| 25,000 ⌆  | Minidisk Port (Level 3) |     1     | [[One Hand](../Keywords/Keyword_One_Hand\.md)], [[Physical](../Keywords/Keyword_Physical\.md)] |
| 100,000 ⌆ | Minidisk Port (Level 4) |     1     | [[One Hand](../Keywords/Keyword_One_Hand\.md)], [[Physical](../Keywords/Keyword_Physical\.md)] |
...
Minidisk Port has no extra capabilities on its own, and it is designed to use the other augments you have installed that can act as sources of data. For example, the [Comms](../Cybernetic_Augmentations/Aug_Comms.md). [Cybernetic Eyes](../Aug_Cybernetic_Eye.md) and [Datajack](../Cybernetic_Augmentations/Aug_Datajack.md) augments could each serve as a source of data to be transferred to a cartridge with Minidisk Port. 

By default, data transferred onto a cartridge using Minidisk Port is converted into an \[Encrypted Package\] and is readable only by you. When you convert a Data Bundle into an \[Encrypted Package\], you must assign a password or create a unique trigger, as described in [[Encrypted Package](../Keyword_Encrypted_Package.md)]. The [[Security](../Keywords/Keyword_Security.md)] used to encode the \[Encrypted Package\] is based on the Minidisk Port level. Minidisk Port (Level 1): Easy (8), Minidisk Port (Level 2): Moderate (14), Minidisk Port (Level 3): Hard (20), Minidisk Port (Level 4): Severe (26).
