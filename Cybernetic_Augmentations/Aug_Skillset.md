...
| :----: | ------------ | :-------: | ----------- | ------------------------------------------------------------------------------------------ |
|   4    | Skillset 1   |     4     | Yes         | Spend 1 AP to download a skill with a +1 \[[[Keywords/Keyword_Skill_Bonus\|Skill Bonus]]\] |
...
Once downloaded, a skill remains available until a new downloaded skill replaces it. A \[Skillset\] can only hold one skill at a time. This augment allows you to use the skill's [[Keywords/Keyword_Core_Trick|Core Tricks]] but not its [[Keywords/Keyword_Signature_Trick|Signature Tricks]].