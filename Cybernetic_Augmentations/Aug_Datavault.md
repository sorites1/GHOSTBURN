...
The \[Datavault\] augment works in conjunction with other augments capable of accessing data, like \[[[Cybernetic_Augmentations/Aug_Comms|Comms]]\], \[[[Vision_Mods/Mods_Video_Recoder|Video Recorder]]\], \[[[Cybernetic_Augmentations/Aug_Datajack|Datajack]]\], and \[[[Cybernetic_Augmentations/Aug_Minidisk|Minidisk]]\]. Spend 1 AP to transfer data into your \[Datavault\]. When special data bundles known as \[Encrypted Packages\] are transferred into your \[Datavault\], they are automatically placed in hidden partitions. No one can access these \[Encrypted Packages\] without the proper key, not even you. 
...
| :----: | ------------ | :-------: | ----------- | ------------------------------------------------------------------------------- |
|   2    | Datavault 1  |     2     | Yes         | Protects data with \[[[Keywords/Keyword_Security\|Security]]\] of Moderate (14) |
