...
Tricks are categorized as being either [[Keywords/Keyword_Core_Trick|core tricks]] or [[Keywords/Keyword_Signature_Trick|signature tricks]]. Anyone may use core tricks, even if they have no skill bonus, but you can only use a signature trick if your character knows it.

When a player wants to try something not covered by the rules, the GM can allow them to perform an [[Keywords/Keyword_Improvised_Trick|improvised trick]].

Refer to the [[Skills_and_Tricks/SaT_Skills_and_Tricks_List|Skills and Tricks List]] for a full list of skills and tricks included in this game.
