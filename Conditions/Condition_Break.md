...
**Removal:** At the start of your turn, make a basic Resilience roll with a DL of Hard (14). Success means you regain control and lose the \[Break\] condition. If the target is a person or group that was caused to \[Break\] by a character, the GM should roll using the target's  Fortitude as the DL (or the highest Fortitude amongst the group).