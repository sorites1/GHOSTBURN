...
NPCs have three traits: \[[[Lexicon/Keywords/Keyword_Wits|Wits]]\], \[[[Lexicon/Keywords/Keyword_Fort|Fort]]\], and \[[[Lexicon/Keywords/Keyword_Threat|Threat]]\]. 
...
The GM can assign a \[Threat\] based on the table below, or they use the rules for [[Calculating_Threat|Calculating Threat]] to derive a bonus from the NPC's \[Wits\] and \[Fort\].
