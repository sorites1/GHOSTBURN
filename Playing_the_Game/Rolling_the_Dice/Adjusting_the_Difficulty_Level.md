...
Conditions like \[[[Lexicon/Conditions/Condition_Wounded|Wounded]]\], \[[[Lexicon/Conditions/Condition_Distracted|Distracted]]\], and \[[[Lexicon/Conditions/Condition_Inspired|Inspired]]\] raise or lower the DL on rolls you make. Conditions are described in their own section later in this book. If a character is under the effects of multiple conditions that alter the DL, they all apply.

#### Environmental Effects

When the environment could negatively influence the outcome of a roll, refer to the appropriate conditions in these rules. Some tricks are more difficult to pull off successfully when it is \[[[Lexicon/Conditions/Condition_Raining|Raining]]\], \[[[Lexicon/Conditions/Condition_Foggy|Foggy]]\], \[[[Lexicon/Conditions/Condition_Windy|Windy]]\] or \[[[Lexicon/Conditions/Condition_Dark|Dark]]\]. To keep things quick, the GM can eschew these specific conditions and decide to simply raise the DL by one anytime there are one or more environmental effects that make a trick more difficult.

### Attitude

When you use a \[[[Lexicon/Keywords/Keyword_Social|Social]]\] trick on an NPC, their \[[[Lexicon/Keywords/Keyword_Attitude|Attitude]]\] towards you can raise or lower the DL.
