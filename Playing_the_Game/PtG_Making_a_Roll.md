...
3. **Trick** - Determine which of the skill's tricks to use. You can use any of the skill's [[Keywords/Keyword_Core_Trick|core tricks]] or a [[Keywords/Keyword_Signature_Trick|signature trick]] if you know one that applies. If you want to do something these rules don't cover, your GM may allow it as an [[Keywords/Keyword_Improvised_Trick|improvised trick]].
   
4. **Difficulty Level** - The trick specifies the [[PtG_Difficulty_Level|Difficulty Level]] for the roll. The GM adjusts the Difficulty Level up or down, as described in [[PtG_Adjusting_the_Difficulty_Level|Adjusting the Difficulty Level]]. 
...
6. **Ability Score and Skill Bonus** - Add the primary ability score based for the skill you're using. If you have a [[Keywords/Keyword_Skill_Bonus|skill bonus]], add that too. For example, the Firearms skill is associated with Agility. If your character has an Agility score of 3 and a +1 skill bonus in Firearms, you would add +4 to your Firearms roll.

7. **Gear and Aug Bonuses** - If you have a [[Keywords/Keyword_Gear_Bonus|gear bonus]] from a piece of equipment or an [[Keywords/Keyword_Aug_Bonus|aug bonus]] from a cybernetic augmentation or psionic mutation, add those as well. For example, using a laser sight grants a +1 gear bonus to Firearms rolls. Bonuses of the same type do not stack, as described below.
   
8. **Result of the Roll** - The sum of your dice roll, plus your ability score and your bonuses is called the result. 
   
9. **Luck Bonus** - After you roll the dice and determine the result, you can spend a [[PtG_Luck_Points|Luck Point]] to add a [[Keywords/Keyword_Luck_Bonus|Luck Bonus]] to the result. 
   
10. **Outcome** - Compare the result to the outcomes chart in the description of the trick you used to determine what happens. 

| Making a Roll                                                                                                                                                                                                                                                             |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2d10 + [[Characters/Char_Abilities_and_Ability_Scores\|Ability Score]] + [[Keywords/Keyword_Skill_Bonus\|Skill Bonus]] + [[Keywords/Keyword_Gear_Bonus\|Gear Bonus]] + [[Keywords/Keyword_Aug_Bonus\|Aug Bonus]] = Result (+ [[Keywords/Keyword_Luck_Bonus\|Luck Bonus]]) |
### Stacking Bonuses
