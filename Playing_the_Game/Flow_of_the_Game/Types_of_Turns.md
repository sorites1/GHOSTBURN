...
During an out-of-combat turn, you might tell the GM your character wants to sneak into the warehouse you learned about from your contact. The GM sets the scene, and you describe what your character is doing. You decide to hop the fence, and the GM calls for an [[Athletic_Move|Athletic Move]] roll (1 AP). As you cautiously approach the warehouse, the GM calls for a [[Sneak|Sneak]] roll (1 AP) to avoid being noticed by the patrolling guards. Last, you use [[Disable_Device|Disable Device]] (1 AP) to override the electronic lock on the door. Those three actions used your 3 AP. If you want to go inside and explore further, you'll have to wait until your next turn. 

The GM is not required to call for any rolls during your turn, and it's important to remember [[Playing_the_Game/Rolling_the_Dice/When_to_Roll|When to Roll]]. Out-of-combat turns can feel less structured than combat turns and rely on both the GM and player to regulate the amount of time spent.

### Combat Turns

During a combat turn, the types of actions may be different, but the process works the same way. If you \[[[Lexicon/Keywords/Keyword_Move|Move]]\] to an area \[[[Lexicon/Keywords/Keyword_Nearby|Nearby]]\] (1 AP), draw your weapon (1 AP), and use [[Burst_Fire|Burst Fire]] to attack an enemy (1 AP), you have spent a total of 3 AP, and your turn ends. At the start of your next turn, your AP will refresh, and you can take three more actions.
