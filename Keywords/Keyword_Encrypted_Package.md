...
An \[Encrypted Package\] can be cracked by breaking the \[[[Keywords/Keyword_Security|Security]]\] that protects it. The \[Security\] of an \[Encrypted Package\] is determined by the device that encrypted the data.