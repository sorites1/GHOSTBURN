...
Transferring an \[[[Lexicon/Keywords/Keyword_Encrypted_Package|Encrypted Package]]\] into your \[Datavault\] relies upon another one of your augments to act as a source of the data. For example, to download an \[Encrypted Package\] from the Net and put it on your \[Datavault\], you could use your [[Datajack|Datajack]]. You could also transfer an \[Encrypted Package\] to your \[Datavault\] from a cartridge in your [[Minidisk_Port|Minidisk Port]]. You cannot transfer a regular Data Bundle into a Datavault; it must be converted into an \[Encrypted Package\] first. Augments like Datajack, Darkline Node, and Minidisk Port, are capable of performing this conversion. 
