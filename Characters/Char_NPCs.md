...
\[Wits\] and \[Fort\] represent the NPC's smarts and toughness, respectively. They are each expressed as a \[[[MaR_Difficulty_Level|Difficulty Level]]\] and come into play when a player uses a trick on the NPC. Want to [[Skills_and_Tricks/Trick_Stealth_Core_Sneak|Sneak]] past a security guard? That targets the NPC's \[Wits\] to see if they notice you. Want to [[Skills_and_Tricks/Trick_Insight_Dodge|Dodge]] the guard's punch? That targets their \[Fort\] to see if you can avoid their fist. 
