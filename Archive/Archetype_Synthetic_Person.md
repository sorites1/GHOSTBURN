...
* **Chameleon:**
	...
	* Deception (Disguise) +1 bonus
	* Strength score +1
	* Agility score +1
	* Intellect score +1
	* Resilience score +1

* **Lifestyle:** You start the game with Homeless Lifestyle

* **Resources:** You gain no cred from this background

* **Special:*** If you purchase Synthetic Person as a Background, you cannot purchase any other Backgrounds.
### Contact

You cannot select Synthetic Person as a contact. 

![[synthetic_person_300x300.png]]
### NPC Synthetic Person

* **Aspects:** \[Little Life Experience\], \[Intelligent\], \[Scared\], \[Wants a Home\]
* **Threat:** +4
* **Attitude:** Neutral
* **Wits:*** Severe (18)
* **Fortitude:** Severe (18)
* **Skill Actions:** Deception (Bluff), Deception (Blend In), Influence (Persuade)
* **Gear:** Hoodie recovered from a dumpster